...
always @(posedge clk)begin
    if (now_state == data_out || now_state == delayTwoCycle) begin  
        ...
        if(isBoundary)begin
            pixel_R <= 255 - R_ram_output;
            pixel_G <= 255 - G_ram_output;
            pixel_B <= 255 - B_ram_output;
        end
        else begin
            pixel_R <= {R_shift_R6[7],R_shift_R6[6],R_shift_R6[5],R_shift_R6[4],R_shift_R6[3],R_shift_R6[2],R_shift_R6[1],R_shift_R6[0]};
            pixel_G <= {G_shift_R6[7],G_shift_R6[6],G_shift_R6[5],G_shift_R6[4],G_shift_R6[3],G_shift_R6[2],G_shift_R6[1],G_shift_R6[0]};
            pixel_B <= {B_shift_R6[7],B_shift_R6[6],B_shift_R6[5],B_shift_R6[4],B_shift_R6[3],B_shift_R6[2],B_shift_R6[1],B_shift_R6[0]};
        end
    end
    else begin
        pixel_R <= 8'dz;
