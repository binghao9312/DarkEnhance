...
#
# Script generated by Vivado on Thu Nov 27 21:18:55 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DarkEnhance.sh
...
#
# Usage        : DarkEnhance.sh
#                DarkEnhance.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DarkEnhance.sh [-reset_run]
#                DarkEnhance.sh [-reset_log]
#                DarkEnhance.sh [-help]
#
...
export RDI_DATADIR="E:/software/AMD/Vivado/Vivado/2024.2/data"
...
# script info
echo -e "DarkEnhance.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DarkEnhance.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/software/AMD/Vivado/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DarkEnhance.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DarkEnhance.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DarkEnhance.sh [-help]\n\
Usage: DarkEnhance.sh [-step]\n\
Usage: DarkEnhance.sh [-lib_map_path]\n\
Usage: DarkEnhance.sh [-reset_run]\n\
Usage: DarkEnhance.sh [-reset_log]\n\
Usage: DarkEnhance.sh [-keep_index]\n\
Usage: DarkEnhance.sh [-noclean_files]\n\n\
