...
#                script (type 'DarkEnhance.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/work/verilog/Project/verilog/Vivado/DarkEnHance/DarkEnhance/DarkEnhance.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
